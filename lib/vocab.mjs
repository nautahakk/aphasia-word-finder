...
const US_WORDS = {
  ...
  "roast dinner": "pot roast", crumble: "cobbler", "mince pie": null, "Yorkshire pudding": null, trifle: null,
...
const US_EXTRA = { time: ["Thanksgiving"], hobbies: ["football", "baseball", "basketball"] };
